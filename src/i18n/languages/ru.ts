...
export const ru: Translation = {
	...
	[Key.sponsorDescription]:
		"Если вам нравятся мои проекты (основной сайт, блог, сайт Celebrate Shatou, панель администрирования Celebrate и другие), вы можете поддержать меня одним из следующих способов. Ваша поддержка помогает мне продолжать творить!",
